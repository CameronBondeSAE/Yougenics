...
public class JohnPathTracker : MonoBehaviour
{
    [Header("Setup:")]
    ...
    public void GeneratePathList(List<Vector2> path)
    {
        pathToFollow = path;
        pathCleared = false;
        atEnd = false;
        ...
        else
        {
            ...
            currentTargetPos = pathToFollow[0];
    ...
    void KeepTrackOfPath()
    {
        ...
        {        
            transform.position = Vector3.MoveTowards(transform.position, new Vector3(currentTargetPos.x, 0, currentTargetPos.y), speed);
